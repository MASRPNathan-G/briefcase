...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
        if IsControlJustReleased(1,  10 ) or IsDisabledControlReleased( 1, 10)) and GetLastInputMethod(0) then ----change 10 to another key (Default Page Up) Controls Can Be Found At: https://docs.fivem.net/game-references/controls/
